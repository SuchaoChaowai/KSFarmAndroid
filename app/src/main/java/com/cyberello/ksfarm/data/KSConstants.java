...
public class KSConstants {
    ...
    public static final String FIRST_FLOOR_IOT_DEVICE_ID = "FIRST_FLOOR_IOT_DEVICE_ID";
    public static final String BED_ROOM_AIR_CON_IOT_DEVICE_ID = "BED_ROOM_AIR_CON_IOT_DEVICE_ID";
    public static final String OVER_HEAD_DESK_LAMP_IOT_DEVICE_ID = "OVER_HEAD_DESK_LAMP_IOT_DEVICE_ID";
    public static final String DESK_LAMP_IOT_DEVICE_ID = "DESK_LAMP_IOT_DEVICE_ID";
    public static final String STANDING_DESK_LAMP_IOT_DEVICE_ID = "STANDING_DESK_LAMP_IOT_DEVICE_ID";
    public static final String BED_SIDE_LAMP_IOT_DEVICE_ID = "BED_SIDE_LAMP_IOT_DEVICE_ID";
    public static final String DESK_TOP_IOT_DEVICE_ID = "DESK_TOP_IOT_DEVICE_ID";
    ...
    public static final String KS_FARM_IOT_META_URL = "http://192.168.0.168:8080/KSFarm-Server/iot/iot-meta.json";
}
